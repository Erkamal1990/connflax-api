    ...
    <ul id="main-menu" class="">
        <div style="text-align: -webkit-center;" id="branding_element">
          <h4 style="color: #a2a3b7;text-align: -webkit-center;margin-bottom: 25px;font-weight: 300;margin-top: 10px;">
              <a href="#"><img class="nav-icon" src="<?php echo SYSTEM_LOGO_EMAIL; ?>" style="max-height:25px;"></a>
          </h4>
        </div>
           ...
           <li class="side-nav-item <?php if ($page_name == 'categories_list' || $page_name == 'category_edit' || $page_name == 'category_create')echo 'active';?>">
               <a href="<?php echo base_url();?>index.php?admin/categories_list" class="side-nav-link <?php if ($page_name == 'categories_list' || $page_name == 'category_edit' || $page_name == 'category_create')echo 'active';?>">
           ...
           <li class="side-nav-item <?php if ($page_name == 'user_reports')echo 'active';?>">
               <a href="<?php echo base_url();?>index.php?admin/user_reports" class="side-nav-link <?php if ($page_name == 'user_reports')echo 'active';?>">
                   <i class="fa fa-flag-checkered"></i>
                   <span> <?php echo get_phrase('user_reports'); ?> </span>
               </a>
           </li>

           <li class="side-nav-item <?php if ($page_name == 'stream_reports')echo 'active';?>">
               <a href="<?php echo base_url();?>index.php?admin/stream_reports" class="side-nav-link <?php if ($page_name == 'stream_reports')echo 'active';?>">
                   <i class="fa fa-globe"></i>
                   <span> <?php echo get_phrase('stream_reports'); ?> </span>
               </a>
           </li>
...
<!-- 
           ...
           <li class="side-nav-item <?php if($page_name == 'Please upload your doc.')echo 'active';?>">
               <a href="<?php echo base_url();?>index.php?admin/manage_language" class="side-nav-link <?php if($page_name == 'Please upload your doc.')echo 'active';?>">
                   <i class="fa fa-language"></i>
                   <span> <?php echo get_phrase('Manage Languages'); ?> </span>
               </a>
           </li>
