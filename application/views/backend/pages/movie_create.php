		...
		<form method="post" action="<?php echo base_url();?>index.php?admin/movie_create" enctype="multipart/form-data">
	        <div class="panel panel-primary">
	            ...
	            <div class="panel-body">
	                ...
	                <div class="form-group mb-3">
	                    <label for="url">Movie Trailer</label>
						<span class="help">- youtube or any hosted video</span>
	                    <input type="file" class="form-control" name="trailer" accept=".mp4,.3gp,.avi" required="">
	                </div>
	                <hr/>
	                ...
	                <div class="form-group mb-3">
						...
						<span class="help">- video of the movie</span>
	                    <input type="file" class="form-control" name="video" accept=".mp4,.3gp,.avi" required="">
	                </div>
	                <hr/>
					...
					<div class="form-group mb-3">
	                    ...
	                    <input type="file" class="form-control" name="thumb" accept=".jpg,.png,.jpej">
	                </div>

					<div class="form-group mb-3">
	                    <label for="">Poster</label>
						<span class="help">- large banner image of the movie</span>
	                    <input type="file" class="form-control" name="poster"  accept=".jpg,.png,.jpej">
	                </div>
					...
					<div class="form-group mb-3">
						...
						<span class="help">- select multiple category</span>
						<select class="form-control select2" id="categories" multiple name="categories[]" required>
							<?php
								$actors	=	$this->db->get('categories')->result_array();
								foreach ($actors as $row2):?>
