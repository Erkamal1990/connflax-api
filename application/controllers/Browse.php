...
* Developer : connflix
* Date : November, 2018
* Support : http://support.connflix.com
*/
...
class Browse extends CI_Controller {
	...
	function filter($type = '', $genre_id = '', $actor_id = '')
	{
		...
		$page_data['items'] = $this->crud_model->get_actor_genre_wise_movies_and_tv_series($actor_id, $type, $genre_id);
